...
import org.openl.repository.migrator.jcr.api.InheritedProperty;
import org.openl.repository.migrator.jcr.api.RLock;
import org.openl.repository.migrator.jcr.api.RVersion;
import org.openl.repository.migrator.jcr.api.ValueType;
...
public class JcrEntityAPI extends JcrCommonArtefact implements ArtefactAPI {
     ...
     */
    private Map<String, org.openl.repository.migrator.jcr.api.Property> properties;
    ...
    @Override
    public Collection<org.openl.repository.migrator.jcr.api.Property> getProperties() {
        return properties.values();
    }

    @Override
    public org.openl.repository.migrator.jcr.api.Property getProperty(String name) throws PropertyException {
        org.openl.repository.migrator.jcr.api.Property rp = properties.get(name);
    ...
    @Override
    public org.openl.repository.migrator.jcr.api.Property removeProperty(String name) throws PropertyException {
        org.openl.repository.migrator.jcr.api.Property rp = getProperty(name);
    ...
    private RepositoryProjectVersionImpl createRepositoryProjectVersion(RVersion rv,
        ...
        RepositoryProjectVersionImpl repositoryProjectVersion = new RepositoryProjectVersionImpl(rv, rvii);
        repositoryProjectVersion.setVersionComment(versionComment);
        return repositoryProjectVersion;
    }
