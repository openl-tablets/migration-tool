package org.openl.repository.migrator.jcr.utils;

import org.openl.repository.migrator.jcr.JcrNT;
import org.openl.repository.migrator.jcr.JcrVersion;
...
public final class NodeUtil {
    ...
    public static Node createFileNode(Node parentNode, String nodeName) throws RepositoryException {
    ...
    public static InputStream getFileNodeContent(Node node) throws RRepositoryException {
        try {
    ...
    public static long getFileNodeSize(Node node) {
        long result;
    ...
    public static Node getNode4Version(Node node, CommonVersion version) throws RepositoryException {
        Node result = null;
     ...
     * @throws RepositoryException if operation failed
     */
    public static boolean isRootVersion(Version v) throws RepositoryException {
        String name = v.getName();
        return "jcr:rootVersion".equals(name);
    }

    public static Node normalizeOldNode(Node node, CommonVersion version) throws RepositoryException {
    ...
    public static void setupFileNode(Node n) throws RepositoryException {
